...
function About () {
  return (
    <div className='section section--sec'>
      ...
      <p>I use to work with other popular frameworks (Vue 1year, Angular 6months, AngularJS 3years+) always with Ruby on Rails or Django as Server side framework.</p>
      <p>I'm a Software Engineer from Simón Bolívar University (USB, Venezuela), and I've been working as Web Developer since 2014.</p>
    </div>
  )
}
